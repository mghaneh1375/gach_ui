...
export const typeKeyVals = [
  {
    item: translator.value,
    id: 'value',
  },
  {
    item: translator.percent,
    id: 'percent',
  },
];
...
export const allWithCodeKeyVals = [
  {
    item: translator.withCode,
    id: 'withCode',
  },
  {
    item: translator.withoutCode,
    id: 'withoutCode',
  },
  {
    item: commonTranslator.all,
...
export const usedKeyVals = [
  {
    item: translator.used,
    id: true,
  },
  {
    item: translator.notUsed,
    id: false,
  },
  {
    item: commonTranslator.all,
...
export const sectionKeyVals = [
  {
    item: translator.gachExam,
    id: 'gach_exam',
  },
  {
    item: translator.bankExam,
    id: 'bank_exam',
  },
  {
    item: translator.book,
    id: 'book',
  },
  {
    item: translator.schoolQuiz,
    id: 'school_quiz',
  },
  {
    item: translator.classes,
    id: 'classes',
  },
  {
    item: translator.ravanExam,
    id: 'ravan_exam',
  },
  {
    item: translator.counseling,
    id: 'counseling',
  },
  {
    item: translator.content,
    id: 'content',
  },
  {
    item: commonTranslator.all,
