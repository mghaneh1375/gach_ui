...
exports.preProcess = exports.fileRequest = exports.downloadRequest = exports.generalRequest = exports.COMMON_DOWNLOAD_HEADER_AUTH = exports.COMMON_DOWNLOAD_HEADER = exports.COMMON_FILE_HEADER_AUTH = exports.COMMON_FILE_HEADER = exports.COMMON_HEADER_AUTH = exports.COMMON_HEADER = exports.BASE_URL = exports.BASE_SITE_NAME = void 0;

var _axios = _interopRequireDefault(require("axios"));

var _Utility = require("../services/Utility");

var _Common = _interopRequireDefault(require("./../tranlates/Common"));
...
var generalRequest = function generalRequest(url, method, data, dataShouldReturnKey) {
  var token,
      mandatoryFields,
      res,
      _args = arguments;
  return regeneratorRuntime.async(function generalRequest$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          token = _args.length > 4 && _args[4] !== undefined ? _args[4] : null;
          mandatoryFields = _args.length > 5 && _args[5] !== undefined ? _args[5] : undefined;
        ...
        case 10:
          ...
          return regeneratorRuntime.awrap((0, _axios["default"])({
            ...
            method: method,
            baseURL: BASE_URL,
            headers: token !== null && token !== undefined ? COMMON_HEADER_AUTH(token) : COMMON_HEADER,
            data: data
          }).then(function (response) {
            var data = response.data;

            if (data.status === 'nok') {
              if (data.msg === 'Token is not valid') (0, _User.removeAuthCache)();
...
var downloadRequest = function downloadRequest(url, data) {
  var token,
      ...
      res,
      _args3 = arguments;
  return regeneratorRuntime.async(function downloadRequest$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          token = _args3.length > 2 && _args3[2] !== undefined ? _args3[2] : null;
          mandatoryFields = _args3.length > 3 && _args3[3] !== undefined ? _args3[3] : undefined;
        ...
        case 10:
          ...
          return regeneratorRuntime.awrap((0, _axios["default"])({
            ...
            method: 'get',
            baseURL: BASE_URL,
            headers: token !== null && token !== undefined ? COMMON_DOWNLOAD_HEADER_AUTH(token) : COMMON_DOWNLOAD_HEADER,
            responseType: 'blob',
            data: data
...
var fileRequest = function fileRequest(url, method, data, dataShouldReturnKey) {
  var token,
      ...
      res,
      _args4 = arguments;
  return regeneratorRuntime.async(function fileRequest$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          token = _args4.length > 4 && _args4[4] !== undefined ? _args4[4] : null;
          additionalData = _args4.length > 5 && _args4[5] !== undefined ? _args4[5] : undefined;
          mandatoryFields = _args4.length > 6 && _args4[6] !== undefined ? _args4[6] : undefined;
          ...
          _context4.prev = 4;
          if (mandatoryFields !== undefined) additionalData = preProcess(additionalData, mandatoryFields);
        ...
        case 12:
          ...
          return regeneratorRuntime.awrap((0, _axios["default"])({
            ...
            method: method,
            baseURL: BASE_URL,
            headers: token !== null && token !== undefined ? COMMON_FILE_HEADER_AUTH(token) : COMMON_FILE_HEADER,
            data: data
          }).then(function (response) {
            var data = response.data;
...
var preProcess = function preProcess(data) {
  var mandatoryFields = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
